                    ...
                    <div className="col-9">
                        ...
                        <div className="d-flex justify-content-between mb-5 sortBoard">
                            ...
                            <div className="d-flex">
                                <Dropdown options={['最新>最舊','最舊>最新']} type={'time'}/>
                                    ...
                                    <div className="card border-0 rounded-3 shadow position-relative" >
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="card-text">
                                                ...
                                                <time dateTime={drama.date.start} className="fs-b2 text-grey-700">{drama.date.start}~{drama.date.end}</time>
                                            </p>
                                            <p className="card-text">
                                            ...
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <button type="button" className="btn" style={{ "--bs-btn-border-color": "none" }}><span className="material-symbols-rounded text-brand-core fs-2 mx-1 cursor">share</span></button>
