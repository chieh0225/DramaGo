            ...
            <section className="row pt-6 pb-12">
                <div className="col-lg-3 ">
                    ...
                    <ul className="d-none d-lg-block">
                        <li className= {location.pathname == "/adminSystem/tag-manage" ? "bg-brand-100 rounded-bottom rounded-5" : ""}>
                        ...
                        <li className={/^\/adminSystem\/?$/.test(location.pathname) ? "bg-brand-100 rounded-top rounded-5" : ""}>
                            <Link className="fs-b1 text-brand-950 fw-semibold d-flex justify-content-center align-items-center py-5"
                                to="./">
