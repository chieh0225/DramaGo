            ...
            (async () => {
                try {
                    ...
                    if (delId == "null") {
                        ...
                        const res = await axios.delete(`${baseUrl}/api/${apiPath}/cart/${delId}`)
                        setloveState(false)
                    }
                } catch (err) {
                    alert(`新增/刪除有錯誤`, err)
