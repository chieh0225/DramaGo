          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              {modalMode === 'share' ? (
                ...
                <form onSubmit={handleSubmit(onSubmitForm)} ref={formSubmitRef}>
                  {/* 劇會主圖 */}
                  <div className="mb-10">
                        ...
                        {imagesUrl.map((img, index) => (
                          <div className="col" key={img}>
                            <div className="position-relative w-100 mx-2" style={{ height: '150px' }}>
                              <img src={img} alt={`附圖${index + 1}`} className="object-fit" />
                              <i
                                className="fs-4 bi bi-x-square-fill text-brand-600 position-absolute top-0 end-0"
                                style={{ cursor: 'pointer' }}
                  ...
                  <div className="mb-10">
                    <div className="h6 mb-3">
                      ...
                      <input {...register('description')} className="form-control" id="description"></input>
                    </div>
                  </div>
            ...
            <div className="modal-footer">
              {modalMode === 'share' ? (
                <>
                  <input type="text" className="form-control" defaultValue={`${pageUrl}/${unitShareDrama.id}`} />
                  <button type="button" className="btn brandBtn-1-lg w-100 text-white" onClick={copyWebsite}>
                    複製網址
                  </button>
                </>
              ) : modalMode === 'delete' ? (
